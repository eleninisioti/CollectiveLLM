...
def write_file( trial, temp, topp):
    ...
    file_name = (top_dir + "jz_scripts/" + current_date +"_large"+ name + ".slurm")
    ...
    with open(file_name, "w") as file:
        ...
        file.write("")
        command = "torchrun --nproc_per_node 8 scripts/reports/singleagent/server/openended.py " + str(trial) + " " + str(temp) + " " + str(topp)
        file.write(command+ "\n")
