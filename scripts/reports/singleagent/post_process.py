...
top_dir = "results/reports/singleagent/targeted/2level/3distractors/"
#top_dir = "results/reports/multiagent/study_wordcraft/base/"
top_dir = "results/server/2024_04_22/"
trials = 4
...
for project in projects:
    ...
    data = []
    if os.path.exists(project + "/data/results_1.pkl"):
        ...
        for agent_idx in range(config["num_agents"]):
            ...
            for metric in metrics:
                ...
                if metric == "reward" or metric == "inventory_length" or metric == "copy_time":
                    ...
                    last_step = max(results_agent['global_step'])
